...
public class GeoWaveRedisPersistedTimestampRow extends GeoWaveRedisPersistedRow {
  ...
  public GeoWaveRedisPersistedTimestampRow(final short numDuplicates, final byte[] dataId,
      final GeoWaveValue value, final Instant time) {
    this(numDuplicates, dataId, value, time.getEpochSecond(), time.getNano());
  }

  public GeoWaveRedisPersistedTimestampRow(final short numDuplicates, final byte[] dataId,
      final GeoWaveValue value, final long secondsSinceEpic, final int nanoOfSecond) {
