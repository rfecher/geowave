...
public class IteratorConfig {
  ...
  public IteratorConfig(final EnumSet<IteratorScope> scopes, final int iteratorPriority,
      final String iteratorName, final String iteratorClass, final OptionProvider optionProvider) {
    this.scopes = scopes;
