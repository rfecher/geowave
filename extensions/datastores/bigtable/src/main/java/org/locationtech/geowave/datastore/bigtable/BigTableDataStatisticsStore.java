...
public class BigTableDataStatisticsStore extends DataStatisticsStoreImpl {
  ...
  public BigTableDataStatisticsStore(final DataStoreOperations operations,
  ...
  protected ByteArray shortToByteArrayId(final short internalAdapterId) {
    return new ByteArray(ByteArrayUtils.shortToString(internalAdapterId));
  }
  ...
  protected short byteArrayToShort(final byte[] bytes) {
    ...
    return ByteArrayUtils.shortFromString(new ByteArray(bytes).getString());
  }
}
