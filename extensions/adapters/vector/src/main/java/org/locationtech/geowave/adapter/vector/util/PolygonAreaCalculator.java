...
public class PolygonAreaCalculator {
  ...
  private CoordinateReferenceSystem lookupUtmCrs(double centerLat, double centerLon)
  ...
  public double getAreaSimple(Geometry polygon) throws Exception {
    Point centroid = polygon.getCentroid();
    CoordinateReferenceSystem equalAreaCRS = lookupUtmCrs(centroid.getY(), centroid.getX());
  ...
  public double getAreaDensify(Geometry polygon) throws Exception {
    Point centroid = polygon.getCentroid();
    CoordinateReferenceSystem equalAreaCRS = lookupUtmCrs(centroid.getY(), centroid.getX());
  ...
  public void setDensifyVertexCount(double densifyVertexCount) {
