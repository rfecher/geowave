...
public class PropertyFilterVisitorTest {
  @Test
  public void testNumbersTypes() throws CQLException {
    ...
    nf = (NumberRangeFilter) ((NumericQueryConstraint) constraints.getConstraintsByName("e"))
        .getFilter();
    ...
    nf = (NumberRangeFilter) ((NumericEqualsConstraint) constraints.getConstraintsByName("c"))
        .getFilter();
    ...
    nf = (NumberRangeFilter) ((NumericQueryConstraint) constraints.getConstraintsByName("g"))
        .getFilter();
    ...
    nf = (NumberRangeFilter) ((NumericQueryConstraint) constraints.getConstraintsByName("f"))
        .getFilter();
    assertEquals(12, nf.getUpperValue().longValue());
    assertTrue(nf.getLowerValue().doubleValue() == Double.MIN_VALUE);
    assertTrue(nf.isInclusiveHigh());
    ...
    nf = (NumberRangeFilter) ((NumericQueryConstraint) constraints.getConstraintsByName("h"))
        .getFilter();
    ...
    nf = (NumberRangeFilter) ((NumericQueryConstraint) constraints.getConstraintsByName("k"))
        .getFilter();
    assertEquals(4, nf.getLowerValue().longValue());
    assertEquals(6, nf.getUpperValue().longValue());
    assertFalse(nf.isInclusiveHigh());
    ...
    nf = (NumberRangeFilter) ((NumericQueryConstraint) constraints.getConstraintsByName("l"))
        .getFilter();
    assertEquals(4, nf.getLowerValue().longValue());
    assertEquals(6, nf.getUpperValue().longValue());
    assertTrue(nf.isInclusiveHigh());
  ...
  @Test
  public void testTextTypes() throws CQLException {
