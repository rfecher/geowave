...
public enum SymbolicSpectralRange {
   ...
   *
   * <p>
   * This is the "thermal imaging" region, in which sensors can obtain a completely passive picture
   * of the outside world based on thermal emissions only and requiring no external light or thermal
   ...
   *
   * <p>
   * In guided missile technology the 3 to 5 micrometers portion of this band is the atmospheric
   ...
   *
   * <p>
   * Defined by the water absorption, and commonly used in fiber optic telecommunication because of
   * low attenuation losses in the SiO2 glass (silica) medium. Image intensifiers are sensitive to
   * this area of the spectrum. Examples include night vision devices such as night vision goggles.
   */
  NIR("NIR"),
   ...
   *
   * <p>
   * Visible light or simply light. A typical human eye will respond to wavelengths from about 390
   * to 750 nm.
   */
  VIS("VIS"),
