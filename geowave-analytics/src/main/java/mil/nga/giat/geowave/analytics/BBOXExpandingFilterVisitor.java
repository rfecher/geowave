...
/**
 * A {@link DuplicatingFilterVisitor} which expands the {@link BBOX} of the
 * filter by given distances for each box edge.
 * 
		...
		DuplicatingFilterVisitor
{
	 ...
	 * @param expandMaxX
	 *            the distance to expand the box X dimension rightwards
	 * @param expandMinY
	 *            the distance to expand the box Y dimension downwards
	 * @param expandMaxY
