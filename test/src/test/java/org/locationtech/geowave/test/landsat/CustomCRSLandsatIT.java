...
public class CustomCRSLandsatIT extends AbstractGeoWaveIT {
  ...
  @GeoWaveTestStore(
      value = {GeoWaveStoreType.ACCUMULO, GeoWaveStoreType.BIGTABLE, GeoWaveStoreType.CASSANDRA,
  ...
  public void testMosaic() throws Exception {
    ...
    analyzeOptions.setCqlFilter(String.format(
        ...
        BandFeatureIterator.BAND_ATTRIBUTE_NAME, BandFeatureIterator.BAND_ATTRIBUTE_NAME,
    ...
    TestUtils.testTileAgainstReference(swappedRedBlueImg, reference, 0,
