...
http://locationtech.github.io/geowave/packages.html[available packages^] site for currently supported hadoop distributions.
...
As mentioned in the overview the scripts are available from within the http://locationtech.github.io/geowave/packages.html[GeoWave source tar bundle^]
...
up the yum repo config after which you should install geowave-puppet manually and proceed to configure GeoWave on the
