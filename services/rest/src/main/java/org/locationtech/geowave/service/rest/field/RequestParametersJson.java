...
public class RequestParametersJson extends RequestParameters {
  ...
  public RequestParametersJson(Representation request) throws IOException {
    super();
  ...
  private void injectJsonParams(String jsonString) {
  ...
  private Object[] jsonArrayToArray(JSONArray jsonArray) {
    if (jsonArray == null) {
      return null;
    }
