...
public class SpatialTemporalQueryExample
{
	private static final Logger LOGGER = LoggerFactory
			.getLogger(
					SpatialTemporalQueryExample.class);
	...
	private void executePolygonAndTimeRangeQuery()
		...
		final CloseableIterator<SimpleFeature> iterator = dataStore
				.query(
						bldr
								.constraints(
										bldr
												...
												.spatialConstraints(
														GeometryUtils
																.buffer(
																		...
																		13700)
																.getKey())
												.spatialConstraintsCompareOperation(
		...
		final CloseableIterator<SimpleFeature> iterator2 = dataStore
				.query(
						bldr
								.addTypeName(
										adapter.getTypeName())
