...
public abstract class AbstractLexicoderTest<T extends Number & Comparable<T>> {
  ...
  public AbstractLexicoderTest(final NumberLexicoder<T> lexicoder, final T expectedMin,
      final T expectedMax, final T[] unsortedVals, final Comparator<byte[]> comparator) {
    super();
