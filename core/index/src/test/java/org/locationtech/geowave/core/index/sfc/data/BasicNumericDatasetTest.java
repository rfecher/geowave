...
public class BasicNumericDatasetTest {
  ...
  public void testNumericRangesMinValues() {
    ...
    int expectedCount = 3;
    double[] expectedMinValues = new double[] {10, 25, -50};
  ...
  public void testNumericRangesMaxValues() {
    ...
    int expectedCount = 3;
    double[] expectedMaxValues = new double[] {50, 95, 50};
  ...
  public void testNumericRangesCentroidValues() {
    ...
    int expectedCount = 3;
    double[] expectedCentroidValues = new double[] {30, 60, 0};
  ...
  public void testNumericValuesAllValues() {
    ...
    double[] expectedValues = new double[] {25, 60, 0};
