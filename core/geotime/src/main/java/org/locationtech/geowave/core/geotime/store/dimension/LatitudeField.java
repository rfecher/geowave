...
public class LatitudeField extends SpatialField {
  ...
  public LatitudeField(final @Nullable Integer geometryPrecision, final boolean useHalfRange) {
    this(geometryPrecision, useHalfRange, GeometryWrapper.DEFAULT_GEOMETRY_FIELD_NAME);
  }

  public LatitudeField(final @Nullable Integer geometryPrecision, final String fieldName) {
    this(geometryPrecision, false, fieldName);
  }

  public LatitudeField(final @Nullable Integer geometryPrecision, final boolean useHalfRange,
      final String fieldName) {
    this(new LatitudeDefinition(useHalfRange), geometryPrecision, fieldName);
  }

  public LatitudeField(final NumericDimensionDefinition baseDefinition,
