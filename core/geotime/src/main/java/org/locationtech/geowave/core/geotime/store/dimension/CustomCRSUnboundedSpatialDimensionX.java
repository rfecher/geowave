...
public class CustomCRSUnboundedSpatialDimensionX extends UnboundedDimensionDefinition
  ...
  public CustomCRSUnboundedSpatialDimensionX(double interval, byte axis) {
