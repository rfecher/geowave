...
public class BaseMapReduceDataStore extends BaseDataStore implements MapReduceDataStore {
  ...
  public BaseMapReduceDataStore(final IndexStore indexStore,
      final PersistentAdapterStore adapterStore, final DataStatisticsStore statisticsStore,
  ...
  public RecordWriter<GeoWaveOutputKey<Object>, Object> createRecordWriter(
      final TaskAttemptContext context, final IndexStore jobContextIndexStore,
  ...
  @Override
  public RecordReader<GeoWaveInputKey, ?> createRecordReader(final CommonQueryOptions commonOptions,
      ...
      final InternalAdapterStore internalAdapterStore, final AdapterIndexMappingStore aimStore,
      final DataStatisticsStore statsStore, final IndexStore indexStore,
      final boolean isOutputWritable, final InputSplit inputSplit)
  ...
  public List<InputSplit> getSplits(final CommonQueryOptions commonOptions,
    ...
    return splitsProvider.getSplits(baseOperations, commonOptions, typeOptions, indexOptions,
        constraints, adapterStore, statsStore, internalAdapterStore, indexStore, indexMappingStore,
        context, minSplits, maxSplits);
  }
}
