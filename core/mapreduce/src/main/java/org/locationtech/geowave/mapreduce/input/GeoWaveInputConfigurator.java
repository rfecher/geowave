		...
		GeoWaveConfiguratorBase
{
	...
	private static DistributableQueryConstraints getQueryConstraintsInternal(
		...
		if ((queryStr != null) && !queryStr.isEmpty()) {
			final byte[] queryBytes = ByteArrayUtils
					.byteArrayFromString(
							queryStr);
			return (DistributableQueryConstraints) PersistenceUtils
					.fromBinary(
							queryBytes);
		}
		return null;
	...
	private static IndexQueryOptions getIndexQueryOptionsInternal(
		...
		if ((queryStr != null) && !queryStr.isEmpty()) {
			final byte[] queryBytes = ByteArrayUtils
					.byteArrayFromString(
							queryStr);
			return (IndexQueryOptions) PersistenceUtils
					.fromBinary(
							queryBytes);
		}
		return null;
	...
	private static DataTypeQueryOptions<?> getDataTypeQueryOptionsInternal(
		...
		if ((queryStr != null) && !queryStr.isEmpty()) {
			final byte[] queryBytes = ByteArrayUtils
					.byteArrayFromString(
							queryStr);
			return (DataTypeQueryOptions<?>) PersistenceUtils
					.fromBinary(
							queryBytes);
		}
		return null;
	...
	private static CommonQueryOptions getCommonQueryOptionsInternal(
		...
		if ((queryStr != null) && !queryStr.isEmpty()) {
			final byte[] queryBytes = ByteArrayUtils
					.byteArrayFromString(
							queryStr);
			return (CommonQueryOptions) PersistenceUtils
					.fromBinary(
							queryBytes);
		}
		return null;
	...
	public static DistributableQueryConstraints getQueryCosntraints(
			final Class<?> implementingClass,
