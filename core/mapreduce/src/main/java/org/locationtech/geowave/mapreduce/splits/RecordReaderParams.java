...
public class RecordReaderParams<T> extends BaseReaderParams<T> {
  ...
  public RecordReaderParams(final Index index, final PersistentAdapterStore adapterStore,
      ...
      final boolean isAuthorizationsLimiting, final GeoWaveRowRange rowRange, final Integer limit,
      final Integer maxRangeDecomposition, final GeoWaveRowIteratorTransformer<T> rowTransformer,
