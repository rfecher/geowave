...
public class SecondaryIndexStoreFactory extends BaseStoreFactory<SecondaryIndexDataStore> {
  public SecondaryIndexStoreFactory(final String typeName, final String description,
