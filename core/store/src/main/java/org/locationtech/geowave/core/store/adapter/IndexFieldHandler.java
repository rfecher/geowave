...
/**
 * This is used by the AbstractDataAdapter to translate between native values and persistence
 * encoded values. The basic implementation of this will perform type matching on the index field
 * type - for explicitly defining the supported dimensions, use DimensionMatchingIndexFieldHandler
 *
 * @param <RowType>
