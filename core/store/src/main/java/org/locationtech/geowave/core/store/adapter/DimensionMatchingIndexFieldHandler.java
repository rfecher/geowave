...
/**
 * This is internally useful for the AbstractDataAdapter to match field handlers with dimensions by
 * field ID. Any fields with the ID returned by getSupportedIndexFieldIds() will use this handler.
 *
 * @param <RowType>
