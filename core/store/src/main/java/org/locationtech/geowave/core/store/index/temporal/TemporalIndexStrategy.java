...
public class TemporalIndexStrategy implements FieldIndexStrategy<TemporalQueryConstraint, Date> {
  ...
  public static final byte[] toIndexByte(final Date date) {
  ...
  @Override
  public InsertionIds getInsertionIds(final Date indexedData, final int maxEstimatedDuplicateIds) {
