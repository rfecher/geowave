...
public abstract class SecondaryIndexEntryIteratorWrapper<T, RowType>
    implements Iterator<RowType>, CloseableIterator<RowType> {
  ...
  public SecondaryIndexEntryIteratorWrapper(final Iterator<?> scanIterator,
