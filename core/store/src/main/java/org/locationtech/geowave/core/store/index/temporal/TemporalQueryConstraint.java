...
/**
 * A class based on FilterableConstraints that uses temporal values and includes a start date and
 * end date
 */
public class TemporalQueryConstraint implements FilterableConstraints {
  ...
  public TemporalQueryConstraint(final String fieldName, final Date start, final Date end) {
    this(fieldName, start, end, false, false);
  }
  ...
  public QueryFilter getFilter() {
    return new DateRangeFilter(fieldName, start, end, inclusiveLow, inclusiveHigh);
  }
