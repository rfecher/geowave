...
public abstract class ArrayField<T extends CommonIndexValue>
  ...
  @Override
  public NumericData getNumericData(final ArrayWrapper<T> dataElement) {
  ...
  @Override
  public abstract FieldWriter<?, ArrayWrapper<T>> getWriter();

  @Override
  public abstract FieldReader<ArrayWrapper<T>> getReader();
