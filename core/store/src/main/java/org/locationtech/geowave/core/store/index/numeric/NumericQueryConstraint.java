...
/**
 * A class based on FilterableConstraints that uses numeric values and includes a lower and upper
 * range
 */
public class NumericQueryConstraint implements FilterableConstraints {
  ...
  public QueryFilter getFilter() {
    return new NumberRangeFilter(fieldName, lowerValue, upperValue, inclusiveLow, inclusiveHigh);
  }
   ...
   */
  @Override
  public FilterableConstraints intersect(final FilterableConstraints other) {
    if ((other instanceof NumericQueryConstraint)
        && ((NumericQueryConstraint) other).fieldName.equals(fieldName)) {
   ...
   */
  @Override
  public FilterableConstraints union(final FilterableConstraints other) {
    if ((other instanceof NumericQueryConstraint)
        && ((NumericQueryConstraint) other).fieldName.equals(fieldName)) {
      final NumericQueryConstraint otherNumeric = ((NumericQueryConstraint) other);
