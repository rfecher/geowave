...
public class IndexPluginOptions extends DefaultPluginOptions implements PluginOptions {
  ...
  private static Index wrapIndexWithOptions(final Index index, final IndexPluginOptions options) {
    Index retVal = index;
  ...
  public abstract static class BaseIndexBuilder<T extends IndexBuilder> implements IndexBuilder {
