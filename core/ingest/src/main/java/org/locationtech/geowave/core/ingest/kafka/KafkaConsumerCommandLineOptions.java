...
public class KafkaConsumerCommandLineOptions extends KafkaCommandLineOptions {
  ...
  @Parameter(names = "--zookeeperConnect",
  ...
  @Parameter(names = "--autoOffsetReset",
  ...
  @Parameter(names = "--fetchMessageMaxBytes",
  ...
  @Parameter(names = "--consumerTimeoutMs",
  ...
  @Parameter(names = "--reconnectOnTimeout",
