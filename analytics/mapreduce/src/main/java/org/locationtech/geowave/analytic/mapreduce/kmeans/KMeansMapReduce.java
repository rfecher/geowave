...
public class KMeansMapReduce {
  ...
  public static class KMeansMapper extends GeoWaveWritableInputMapper<GroupIDText, BytesWritable> {
    ...
    AssociationNotification<Object> centroidAssociationFn = new AssociationNotification<Object>() {
      ...
      public void notify(final CentroidPairing<Object> pairing) {
        ...
        association.set(p.getCoordinate().x, p.getCoordinate().y, p.getCoordinate().z, extra,
            pairing.getDistance());
      }
    };
    ...
    protected void setup(
      ...
      final ScopedJobConfiguration config = new ScopedJobConfiguration(context.getConfiguration(),
          KMeansMapReduce.class, KMeansMapReduce.LOGGER);
  ...
  public static class KMeansCombiner
    ...
    @Override
    public void reduce(final GroupIDText key, final Iterable<BytesWritable> values,
