...
public class KMeansSingleSampleJobRunner<T> extends MapReduceJobController
  ...
  public KMeansSingleSampleJobRunner() {
    ...
    init(new MapReduceJobRunner[] {sampleSetsRunner, kmeansJobRunner},
  ...
  public Collection<ParameterEnum<?>> getParameters() {
    ...
    params.addAll(Arrays.asList(new ParameterEnum<?>[] {
        ClusteringParameters.Clustering.MAX_REDUCER_COUNT, SampleParameters.Sample.SAMPLE_SIZE,
        ...
        GlobalParameters.Global.BATCH_ID, ClusteringParameters.Clustering.MAX_REDUCER_COUNT}));
