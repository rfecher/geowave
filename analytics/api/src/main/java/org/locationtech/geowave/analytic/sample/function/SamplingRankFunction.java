...
/**
 * Used by {@link KSamplerMapReduce} to rank an object for selection in the sample set. The top k
 * highest ranked objects are sampled. Rank is between 0.0 and 1.0 inclusive.
 */
