...
public class CentroidManagerTest
{
	...
	public void testSampleRecall()
		...
		final PersistentAdapterStore adapterStore = storeFamily
				...
				.createStore(
						opts);
		final InternalAdapterStore internalAdapterStore = storeFamily
		...
		CentroidManagerGeoWave<SimpleFeature> manager = new CentroidManagerGeoWave<>(
				...
				"b1",
				1);
		List<AnalyticItemWrapper<SimpleFeature>> centroids = manager
		...
		manager
				.processForAllGroups(
						new CentroidProcessingFn<SimpleFeature>() {
